/**
 * Shapes the front end works in. These mirror the MVP conceptual model in
 * docs/uml/src/04_domain_mvp.puml and should move to a shared package once the
 * API contract is settled.
 *
